...
export function MessageActions({
    ...
    return (
        <div
            className={`absolute ${isCurrentUser ? 'left-0' : 'right-0'} top-1/2 transform -translate-y-1/2 flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity duration-200 z-10 ${isCurrentUser ? '-translate-x-full -ml-2' : 'translate-x-full ml-2'}`}
