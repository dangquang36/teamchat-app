        ...
        <>
            <div
                className={`${isSidebarExpanded ? "w-80" : "w-20"
                    } border-r transition-all duration-300 ${currentDarkMode ? "bg-gray-800 border-gray-700" : "bg-white border-gray-200"}`}
            >
                    ...
                    <div className="flex items-center justify-between mb-4">
                        {isSidebarExpanded ? (
                            <>
                                ...
                                <Button variant="ghost" size="sm" onClick={() => setIsSidebarExpanded(false)}>
                                    <ChevronLeft className="h-5 w-5" />
                                </Button>
                            </>
                        ) : (
                            <Button variant="ghost" size="sm" onClick={() => setIsSidebarExpanded(true)}>
                ...
                {selectedChatUser ? (
                    <>
                        ...
                        <ChatInput
                            ...
                            // onCreatePoll is removed as it's channel-specific
                            isDarkMode={currentDarkMode}
                        />
                    </>
                ) : (
