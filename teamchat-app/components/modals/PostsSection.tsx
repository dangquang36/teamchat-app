...
export function PostsSection({ isDarkMode = false }: { isDarkMode?: boolean }) {
  ...
  const isSearchExpanded = isSearchHovered || isSearchFocused;
        ...
        >
          ...
          <div className="relative flex items-center justify-end w-full h-12">
            ...
            <input
              ...
              className={`w-full pl-12 pr-4 py-3 border rounded-full outline-none focus:ring-2 focus:ring-purple-500 transition-all duration-300 ease-in-out text-sm absolute top-0 right-0
                ...
                ${isSearchActive ? 'w-full opacity-100' : 'w-12 opacity-0 pointer-events-none'}`}
            />
